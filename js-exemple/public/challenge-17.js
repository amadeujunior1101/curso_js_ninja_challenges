...
*/
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, "Amadeu Jr"));
...
*/
  ...
  console.log(text.replace(/brasileiro/, "Augustinópolino"));
...
*/
  ...
  console.log(
    text.replace(/O Centauro de Luvas/, (item) => {
...
*/
  ...
  let regexDate = /(\d\d) de (\w\w\w\w\w) de (\d\d\d\d)/g;
...
*/
  console.log("\nReplace de datas:");
  function replaceDate(regexFull, day, month, year) {
