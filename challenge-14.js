...
*/
  console.log("\nOperation:");
  let operation = justMod2Or3.reduce((accumulator, current) => {
...
*/
  console.log("\nOperation 2:");
  let operation2 = justMod2Or3.reduceRight((accumulator, current) => {
    return (accumulator + 1) * current;
  }, 0);
...
*/
  ...
  let name = ["LA", "RIS", "SA"];
  let reduceP = name.reduce((accumulator, current) => {
...
*/
  console.log("\nInversed Name:");
  let inversedName = name.reduceRight((accumulator, current) => {
